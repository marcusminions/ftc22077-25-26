...
public class PIDController {
    ...
    public void update() {
        ...
        if(max>1)
            bot.driveFieldXYW(yVal/max*maxSpeed.get(), xVal/max*maxSpeed.get(), 0*thetaVal*maxAngSpeed.get());
        else
            bot.driveFieldXYW(yVal*maxSpeed.get(), xVal*maxSpeed.get(), 0*thetaVal*maxAngSpeed.get());
